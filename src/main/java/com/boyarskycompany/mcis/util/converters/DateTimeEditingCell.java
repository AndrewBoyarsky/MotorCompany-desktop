...
public class DateTimeEditingCell<T> extends TableCell<T, Timestamp> {
        ...
        if (empty) {
            ...
            if (isEditing()) {
                if (dateTimePicker != null) {
                    ...
                    Calendar cal = Calendar.getInstance(MainApplicationEntry.getLanguageResourceBundle().getLocale());
                    cal.setTime(getDate());
                ...
                SimpleDateFormat format = new SimpleDateFormat("dd.MM.yyyy hh:mm", MainApplicationEntry.getLanguageResourceBundle().getLocale());
    ...
    private void createDatePicker() {
        ...
        dateTimePicker.setLocale(MainApplicationEntry.getLanguageResourceBundle().getLocale());
        Calendar cal = Calendar.getInstance(MainApplicationEntry.getLanguageResourceBundle().getLocale());
        cal.setTime(getDate());
